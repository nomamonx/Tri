...
Tab:CreateSection("─── 🛡️ SECURITY STATUS ───")
Tab:CreateParagraph({Title = "ANTI-ERROR 600", Content = "Sistem ini menggunakan sinkronisasi CFrame-Velocity. Jika terkena kick, turunkan speed ke 50 karena server membatasi jarak tempuh per detik."})
